...
function Navbar(props){
    return(
      <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-margin static-top">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#DBD4D3" class="bi bi-cart" viewBox="0 0 16 16">
